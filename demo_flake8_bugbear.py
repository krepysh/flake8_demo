...
def batch_check_printer(printers=None) -> list:
...
class DummyFloat:
    ...
    def __float__(self):
        AssertionError, "__float__ should not be invoked for comparisons"

    # same goes for subtraction
    def __sub__(self, other):
        AssertionError, "__sub__ should not be invoked for comparisons"
